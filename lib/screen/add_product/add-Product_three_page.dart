...
class StepThreeProductAdd extends StatefulWidget {


  @override
  _StepThreeProductAdd createState() => _StepThreeProductAdd();
}

class _StepThreeProductAdd extends State<StepThreeProductAdd>
                            ...
                            child: Container(
                              child: Padding(
                                  ...
                                  child: TextField(
                                    ...
                                    controller: proController.proDetails,
                            ...
                            child: Container(
                              child: Padding(
                                  ...
                                  child: TextField(
                                    ...
                                    controller: proController.proDetailsP,
                                    style: TextStyle(color: Color(0xFF002e80)),
                                    decoration: InputDecoration(
                                        contentPadding: EdgeInsets.all(15),
                                        labelStyle:
...
// and:
                        ...
                        Row(
                          children: [
                            ...
                            new Spacer(),
                            proController.imageFile==null?Visibility(child: Text(''),visible: false,):InkWell(child: Icon(Icons.delete_forever_sharp,color: Color(0xFF002e80)),
                              onTap: (){
                                setState(() {
                                  proController.imageFile=null;
                                });
                              },)
                          ],
                        ),
                        ...
                        Center(
                            child: proController.imageFile == null
                                ? InkWell(
                                    onTap: () {
                                ...
                                child:Image.file(
                                    File(proController.imageFile!.path),
                                    height: 300,
                                    width: Get.width,
                                  ))),
                        SizedBox(
                        ...
                        Row(
                          children: [
                            Checkbox(
                              ...
                              value: proController.isCheckedHide,
                              activeColor: Color(0xFF002e80),
                              onChanged: (bool? value) {
                                setState(() {
                                  proController.isCheckedHide = value!;
                                });
                              },
                            ),
                            Text(
                        ...
                        proController.isCheckedHide == false
                            ? Visibility(
                                child: Text(''),
                                visible: false,
                              )
                                        ...
                                        onTap: () {
                                          DatePicker.showDatePicker(context,
                                            ...
                                            print('change $date in time zone ' +
                                                date.timeZoneOffset.inHours
                                                    .toString());
                                            proController.datee.value = date
                                                .toString()
                                                .substring(0, 10);
                                          }, onConfirm: (date) {
                                            print('confirm $date');
...
// and:
  ...
  Future<void> _onImageButtonPressed(ImageSource source,
    ...
    if (pickedFile != null) {
      setState(() {
        proController.imageFile = pickedFile;
      });
    }
  }
