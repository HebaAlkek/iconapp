...
class CustomerCard extends StatelessWidget {
  ...
  CustomerCard(this.layout, this.contextt);
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
           ...
           ,
                ...
                Padding(
                  ...
                  child: Container(
                    width: Get.width / 2.4,
                    child: Text(
                      S.of(context).conm +' : '+ layout.company,
                      maxLines: 2,
                      overflow: TextOverflow.ellipsis,
          ...
          new Spacer(),
       posController.permission.value.length != 0?   posController.cusEdit=='1'?posController.cusDelete=='1'?     PopupMenuButton(
              elevation: 10,
              ...
              onSelected: (value) async {
                                    ...
                                    Expanded(
                                      child: ElevatedButton(
                                        onPressed: () {
                                          ...
                                          customerController.deleteCustomer(contextt, layout.id);
                                        },
                ...
                Get.to(() => AddCustomerPage('2',layout.id));
                }
                //  _value = value;
              },
              itemBuilder: (context) => [
          ...
          posController.cusDelete=='1'?     PopupMenuButton(
              elevation: 10,
              shape: OutlineInputBorder(
                  borderSide: BorderSide(
                      color: Colors.grey.withOpacity(0.2), width: 1)),
